...
make_prediction:
	python src/tennis_predictor/data/pipelines/predict.py

make_evaluation:
	python src/tennis_predictor/data/pipelines/evaluate.py

make_all: make_database make_prediction make_evaluation
